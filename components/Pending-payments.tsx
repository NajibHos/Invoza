import { GetPendingPayments } from "@/actions/dashboard-action";

export default async function PendingPaymentCard({ userId }: { userId: string}) {

    // get pending projects
    const total = await GetPendingPayments(userId);
